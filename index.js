...
app.get('/', (req, res) => {
    ...
    setInterval(() => {https.get('https://leaderboard-server-002x.onrender.com/', (res) => {
        console.log('Self-ping poslan: Status', res.statusCode);
    }).on('error', (err) => {console.log('Ping greška: ' + err.message); });
}, 600000); // 600000 ms =10 minuta